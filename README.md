...
**Facilitating a live class?** Read [docs/SPRK_Facilitator_Guide.md](docs/SPRK_Facilitator_Guide.md) for the cheat sheet, hosting paths (laptop Wi‑Fi vs Cursor Cloud tunnel), and a stable bit.ly link pattern for iPhones and Chromebooks.
